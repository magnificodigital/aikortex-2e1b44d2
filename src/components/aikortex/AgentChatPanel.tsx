...
const AGENT_SUGGESTIONS: { emoji: string; label: string; prompt: string }[] = [
  ...
  { emoji: "🎧", label: "Suporte 24/7", prompt: "Suporte ao cliente 24/7 no WhatsApp que responde dúvidas frequentes e abre chamado quando não resolve" },
  ...
  { emoji: "✍️", label: "Criar conteúdo", prompt: "Gestor de conteúdo que cria posts e responde comentários e mensagens nas redes sociais" },
  { emoji: "🍽️", label: "Reservar mesas", prompt: "Recepcionista de restaurante que reserva mesas via WhatsApp e tira dúvidas do cardápio" },
  { emoji: "💰", label: "Cobrar faturas", prompt: "Agente de cobrança que lembra clientes de faturas em atraso de forma amigável e oferece formas de pagamento" },
  { emoji: "🏠", label: "Vender imóveis", prompt: "Corretor virtual que qualifica interessados em imóveis, agenda visitas e tira dúvidas sobre financiamento" },
  ...
  { emoji: "💇", label: "Agendar salão", prompt: "Atendente de salão de beleza que agenda horários, informa serviços e preços pelo WhatsApp" },
  { emoji: "🏋️", label: "Matrícula de academia", prompt: "Consultor de academia que tira dúvidas sobre planos, agenda aula experimental e converte matrículas" },
  { emoji: "📚", label: "Atender alunos", prompt: "Atendente de escola/curso online que responde dúvidas sobre matrículas, turmas e valores" },
  ...
  { emoji: "🧾", label: "Atender contábil", prompt: "Assistente de escritório contábil que responde dúvidas de clientes sobre documentos, prazos e impostos" },
  { emoji: "🚗", label: "Vender veículos", prompt: "Vendedor de concessionária que qualifica interessados, agenda test drive e tira dúvidas sobre modelos" },
  { emoji: "✈️", label: "Vender viagens", prompt: "Consultor de viagens que monta roteiros, cota pacotes e tira dúvidas sobre destinos pelo WhatsApp" },
  { emoji: "🐾", label: "Atender pet shop", prompt: "Atendente de pet shop que agenda banho e tosa, tira dúvidas sobre produtos e serviços veterinários" },
  { emoji: "🏨", label: "Reservar hotel", prompt: "Recepcionista de hotel/pousada que faz reservas, informa disponibilidade e responde dúvidas dos hóspedes" },
  { emoji: "📦", label: "Rastrear pedidos", prompt: "Agente de e-commerce que informa status de pedido, rastreio, troca e devolução" },
  { emoji: "🎓", label: "Captar alunos", prompt: "SDR educacional que qualifica interessados em cursos e agenda conversa com consultor de matrículas" },
  { emoji: "💳", label: "Renegociar dívidas", prompt: "Agente que negocia dívidas com clientes, propõe parcelamento e envia boleto de acordo" },
  { emoji: "🩺", label: "Triagem de saúde", prompt: "Assistente de saúde que faz triagem de sintomas, orienta e encaminha para o profissional certo" },
  ...
  { emoji: "🧑‍💼", label: "Recrutar candidatos", prompt: "Recrutador que faz triagem de candidatos, aplica perguntas de screening e agenda entrevistas" },
  ...
  { emoji: "🏦", label: "Captar investidores", prompt: "Consultor financeiro que qualifica interessados em investimentos e agenda reunião com assessor" },
  { emoji: "🔧", label: "Abrir ordem de serviço", prompt: "Atendente de assistência técnica que abre ordem de serviço, agenda visita e informa orçamento" },
  { emoji: "🎉", label: "Orçar eventos", prompt: "Atendente de buffet que qualifica orçamentos de festas, agenda visita e tira dúvidas de cardápio" },
  { emoji: "🚚", label: "Cotar frete", prompt: "Agente de logística que cota fretes, informa prazos e status de entrega pelo WhatsApp" },
  { emoji: "🧘", label: "Agendar aula (yoga)", prompt: "Atendente de estúdio que agenda aulas experimentais, informa planos e horários" },
  { emoji: "🖥️", label: "Onboarding de SaaS", prompt: "Agente de onboarding que guia novos usuários de um software nos primeiros passos e tira dúvidas" },
  { emoji: "🌱", label: "Pós-venda e NPS", prompt: "Agente de pós-venda que acompanha o cliente, coleta NPS e reduz churn com follow-ups" },
  { emoji: "🏥", label: "Agendar exames", prompt: "Assistente de laboratório que agenda exames, informa preparo e convênios aceitos" },
  { emoji: "📸", label: "Agendar ensaio foto", prompt: "Atendente de estúdio de fotografia que cota ensaios, agenda sessões e tira dúvidas de pacotes" },
  { emoji: "🛍️", label: "Vender roupas", prompt: "Vendedor de loja de roupas que apresenta novidades, tira dúvidas de tamanho e fecha vendas no WhatsApp" },
  { emoji: "🧑‍🍳", label: "Receber delivery", prompt: "Atendente de delivery que recebe pedidos, sugere combos e informa tempo de entrega" },
  { emoji: "💊", label: "Atender farmácia", prompt: "Atendente de farmácia que tira dúvidas sobre produtos, verifica disponibilidade e organiza entregas" },
  { emoji: "🏗️", label: "Orçar reformas", prompt: "Atendente de empresa de reformas que qualifica orçamentos, agenda visita técnica e tira dúvidas" },
  { emoji: "📈", label: "Captar clientes (mkt)", prompt: "SDR de agência de marketing que qualifica empresas interessadas e agenda diagnóstico gratuito" },
  { emoji: "🚨", label: "Vender segurança", prompt: "Atendente de empresa de segurança que qualifica interessados em alarmes/câmeras e agenda instalação" },
  { emoji: "🧴", label: "Vender cosméticos", prompt: "Consultora de cosméticos que recomenda produtos, tira dúvidas de pele e fecha vendas" },
  { emoji: "🎸", label: "Matrícula de música", prompt: "Atendente de escola de música que agenda aula experimental, informa instrumentos e planos" },
  { emoji: "🐶", label: "Atender creche pet", prompt: "Atendente de creche/adestramento pet que agenda diárias, tira dúvidas e informa valores" },
  { emoji: "🏦", label: "Vender crédito", prompt: "Agente que qualifica interessados em crédito/consignado, coleta dados e encaminha para análise" },
  { emoji: "🧑‍⚕️", label: "Agendar fisioterapia", prompt: "Recepcionista de clínica de fisioterapia que agenda sessões, confirma horários e informa convênios" },
  { emoji: "📱", label: "Orçar conserto celular", prompt: "Atendente de assistência de celulares que informa orçamento de reparo, prazo e agenda o conserto" },
  { emoji: "🌐", label: "Vender internet", prompt: "Atendente de provedor de internet que qualifica interessados em planos, verifica cobertura e agenda instalação" },
  { emoji: "🎂", label: "Orçar festa infantil", prompt: "Atendente de buffet infantil que cota festas, verifica datas disponíveis e agenda visita" },
  { emoji: "🧑‍🏫", label: "Agendar aula particular", prompt: "Atendente de professor particular que agenda aulas, informa valores e monta plano de estudos" },
  { emoji: "🏢", label: "Reservar coworking", prompt: "Atendente de coworking que informa planos de sala/mesa, agenda visita e faz reservas" },
  { emoji: "♻️", label: "Vender energia solar", prompt: "SDR de energia solar que qualifica interessados, coleta conta de luz e agenda visita técnica" },
];

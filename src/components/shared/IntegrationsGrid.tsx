...
export const LLM_PROVIDERS: IntegrationProvider[] = [
  ...
  },
  {
    label: "Qwen",
    provider: "qwen",
    description: "Qwen 3, Max e modelos multilíngues da Alibaba (DashScope)",
    logo: "https://cdn.simpleicons.org/alibabacloud/FF6A00",
    apiKeyUrl: "https://bailian.console.alibabacloud.com/",
    apiKeyUrlLabel: "dashscope (Alibaba)",
    tags: ["llm"],
  },
  {
    label: "Kimi",
    provider: "kimi",
    description: "Kimi K2 e modelos de contexto longo da Moonshot AI",
    logo: "https://cdn.simpleicons.org/moonrepo/30BCA6",
    apiKeyUrl: "https://platform.moonshot.ai/console/api-keys",
    apiKeyUrlLabel: "platform.moonshot.ai",
    tags: ["llm"],
  },
  {
    label: "GLM",
    provider: "glm",
    description: "GLM-4 e modelos da Zhipu AI (Z.ai)",
    logo: "https://cdn.simpleicons.org/zhihu/0084FF",

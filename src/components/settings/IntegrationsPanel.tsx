...
import { Check, Eye, EyeOff, ExternalLink, Blocks, Plus, Trash2, Webhook, Globe, Bot, MessageSquare, Phone, Mic } from "lucide-react";
    ...
    <div className="space-y-8">
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Conecte provedores para que cadências e automações enviem mensagens.</p>
        </div>
